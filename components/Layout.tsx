...
import { LayoutDashboard, ClipboardCheck, FileText, LogOut, Menu, UserCircle, Calendar, Shield } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, setActiveTab, currentUser, onLogout }) => {
  ...
  // Note: Contacts removed from here as it is moved to Admin Panel per request
  const menuItems = [
