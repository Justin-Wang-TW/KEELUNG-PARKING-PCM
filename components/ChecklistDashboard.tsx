...
import { ClipboardList, Plus, Search, Settings, FileCheck, AlertCircle, Eye, ExternalLink, Image as ImageIcon, ChevronDown, ChevronRight, BarChart3, AlertTriangle } from 'lucide-react';
      ...
      {activeSubTab === 'overview' ? (
        <>
          ...
          <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex flex-wrap gap-4 items-end">
            <div>
              <label className="text-xs font-bold text-gray-700 block mb-1">場站篩選</label>
              <select
                value={filterStation}
