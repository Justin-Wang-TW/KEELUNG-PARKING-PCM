...
export const APP_CONFIG = {
  SHEET_ID: '14GwM3Mua-ixjJnNRVSJTeBSL8WET-JR_XQc8xjkZ5Lk',
  // 注意：此處 URL 應與 App.tsx 中使用的 API 位址保持一致
  SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbzFjcs8eHmQJprwMcf74yClgy4wklBm45KJx75MzSq7S9W0thgDjcxmD1y2PB2L2UbO/exec',
