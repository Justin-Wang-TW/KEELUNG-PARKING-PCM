...
export const APP_CONFIG = {
  SHEET_ID: '1sBzd487e3epbezI2T3HxOMmpMhE6tPo5LvbrBiQD81E',
  // 注意：此處 URL 應與 App.tsx 中使用的 API 位址保持一致
  SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbzDHnlhh6D1et8Npi7Afq5h5dZ-v_v9Y2qiBdON8-3r-SEf1-kDMgRB0pPtIMLa204s/exec',
